...
const LandingNav = ({ onCTA }: { onCTA: () => void }) => {
  ...
  return (
	...
	<div className="flex items-center">
 	 <img src={logo} alt="StriveHub logo" className="h-11 w-auto mr-2" />
	</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={onCTA}
            className="text-sm font-semibold px-5 py-2 rounded-full text-white transition-all hover:scale-[1.02]"
